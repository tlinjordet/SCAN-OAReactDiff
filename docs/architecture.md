...
Reference for how the codebase is put together. See `CLAUDE.md` for setup
and commands, and `docs/terminology.md` before reading further — several
of the terms below (`fragment_names`, `n_frag_switch`) use an overloaded
sense of "fragment" that is easy to misread.
