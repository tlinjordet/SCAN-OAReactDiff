...
model_type = "leftnet"
version = "C6H6_5710-0-woSL-woBL-w3pBC-StepLR-cutoff_12-bz64-rep0" # update
...
training_config = dict(
    datadir="../data/C6H6_5710-0-woSL-woBL-w3pBC/", # update
    remove_h=False,
    bz=64,
    num_workers=0,
    clip_grad=True,
...
node_nfs: List[int] = [13] * 3 # was: [9] * 3  # 3 (pos) + 5 (cat) + 1 (charge)
...
loss_type = "l2"
pos_only = True
process_type = "SCAN" # was: "TS1x" or "SCAN" # update
...
trainer.fit(ddpm)
trainer.save_checkpoint(f"pretrained-C6H6-diff-{version}.ckpt") # update
