...
model_type = "leftnet"
version = "combined_C6H6_570-filtered_and_Ts1x-LBS_32x8-StepLR-cutoff_21-rep0"
...
training_config = dict(
    datadir="../data/combined_C6H6_filtered_and_transition1x/",
    remove_h=False,
    bz=8,
    num_workers=0,
    clip_grad=True,
...
trainer = Trainer(
    ...
    profiler=None,
    logger=wandb_logger,
    accumulate_grad_batches=32, # LBS Nx. Was: =1,
